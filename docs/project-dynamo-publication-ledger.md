...
- **Cabin vocabulary:** Introduced Anthracite, Sandstone, Nantucket Fog, and Brushed Aluminum as functional material names. Added selected model-level discoveries including Oxblood, Glacier Blue Clearcoat, After Six Black, Champagne Clearcoat Metallic, and Travertine without turning the presentation into a complete order guide.
