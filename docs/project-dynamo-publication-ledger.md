...
## 2026-08-27 — Reframed website and 24-page auto show viewbook

- **Opening proposition:** Rebuilt the shared opening around a direct question: how can an established automaker offer genuine product choice when consumer taste, fuel prices, charging access, incentives, regulation, and political priorities can move faster than a vehicle program? Added the restrained basketball shoe silhouette and the Sandy Torchon roller-coaster photograph as complementary explanations of form-factor uniformity and market volatility.
- **Independent framing:** Added an introductory note outside the Clark fiction. Its first reference states that “The Clark Motor Company is a fictional manufacturer and brand.” On the website and inside cover, the note appears as a vertically and horizontally centered, fully justified lockup with large margins; the approved free-floating badge sits below it as the transition into the fictional presentation. The Clark badge was removed from the brochure front cover.
- **Architecture explanation:** Added a four-system comparison that separately explains a traditional internal-combustion drivetrain, a representative conventional hybrid, a BEV, and a Dynamo Petro-Electric series hybrid. The locomotive now follows that explanation and confirms it by stating that its diesel engine turns an alternator and the resulting electricity powers traction motors. Standardized “Midship Energy Bay” and made the production-installed Power Cassette, its interfaces, and its lack of a mechanical wheel connection explicit.
- **Shared narrative:** Aligned both media around the same sequence: premise and market problems; PE / BEV energy strategies; propulsion and locomotive explanation; Energy Bays, Power Cassette, and production logic; nine-model family; passenger and work uses; interiors, colors, materials, and hardware; Cabin Intelligence; performance derivatives and simulated targets; system value; engineering limits; curated precedents; future possibilities; and the Clark coda.
- **Copy and claims:** Removed the rejected firstness, speculative-traction, starting-lineup, benchmark-versus-price, and ICE-platform formulations. Retained ordinary-model performance targets and framed higher-output derivatives around progressive, predictable performance for ordinary drivers. Derivatives and changes in the PE / BEV mix preserve architecture and production knowledge without implying that body-specific tooling disappears.
- **Brochure rebuild:** Replaced the existing public PDF in place with a maintainable 24-page ReportLab viewbook. Its cover uses only solid and gradient color; photography and copy occupy separate fields throughout; missing Constellation seating imagery is restored; TaskVan carries the work-use sequence without separate Foreman or Ranch spotlights; and the palette page mirrors the website’s clearcoat, metallic, smooth, woven, and hardware finish logic.
- **Closing and credits:** The final page returns the free-floating Clark badge and “Time after time” slogan, then provides the study disclaimer, image credits, Pexels license link, Cognisint badge, copyright statement, and website address. No existing approved image asset was generated, edited, retouched, recolored, cropped, or replaced; the only new photographic asset is the credited Pexels roller-coaster image, and the shoe is an original vector illustration in the website and brochure source.
- **Intentional medium differences:** The website retains interactive model portfolios, its separate Colors and Materials page, expanded technical tables, and brochure links. The viewbook uses fixed cinematic pagination, a consolidated palette page, and more selective technical detail while preserving the same argument, facts, names, claims, and disclaimers.
- **Verification:** The Next.js production build and lint passed. The final PDF contains 24 landscape-letter pages with ReportLab metadata and searchable text. All pages were rendered and visually inspected, with the opening lockup, production logic, material swatches, and closing disclosures rechecked at full-page scale; no clipping, overlaps, broken glyphs, stale labels, or text-over-photo transparency defects remained. Desktop and 390-pixel browser checks confirmed the intended hierarchy, no horizontal overflow, and the shared brochure URL. The synchronized baseline was recorded only after the strict pair audit passed.
