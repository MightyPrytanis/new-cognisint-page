      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <article className="writing-article-shell overflow-hidden">
          ...
          <div className="article-body space-y-6 px-6 py-8 text-lg leading-8 sm:px-10 lg:px-12">
            ...
            <p>
              I knew this person to be an engaged, caring, thoughtful educator. She has an elite academic pedigree,
              professional IT expertise, and a wealth of hard-earned experience in the
